import { SignupInput } from "@shailo2002/medium-common";
...
export const Auth = () => {
    //trpc project to read more about type safety
            ...
            <div className="flex flex-col items-center justify-center p-10">
                ...
                <div className="flex text-l  text-slate-400">
                    <div>Already have an account?
                        <Link className=" pl-2 underline" to="/signin">Login</Link></div>
                </div>
            </div>
            <LabelledInput label="Name" placeholder="shailesh" onChange={(e) => {
                setPostInputs({
                    ...postInputs,
                    name: e.target.value
                })
